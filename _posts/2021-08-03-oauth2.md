...
The solution was simple: before sending a user to the provider, generate a random nonce and link it to the user session. When the user is back, the domain_B have to ensure the state received was equal to the previous one generated.
